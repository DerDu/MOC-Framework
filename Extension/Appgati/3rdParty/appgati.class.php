...
class AppGati {
  ...
  public function Report($plabel, $slabel) {
    try {
      ...
      $array['Integral unshared stack size'] = isset($results['usage']['ru_isrss'])?$results['usage']['ru_isrss']:'';
      ...
      $array['Number of block output operations'] = isset($results['usage']['ru_outblock'])?$results['usage']['ru_outblock']:'';
