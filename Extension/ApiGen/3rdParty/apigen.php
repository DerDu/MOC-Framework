...
if (false === strpos('@php_dir@', '@php_dir')) {
	...
	@include_once '@php_dir@/Nette/loader.php';
	@include_once '@php_dir@/Texy/texy.php';
} else {
	// Downloaded package
	...
	@include_once __DIR__ . '/libs/Nette/Nette/loader.php';
	@include_once __DIR__ . '/libs/Texy/texy/texy.php';
}

// Autoload
spl_autoload_register(function($class) {
	$class = trim($class, '\\');
	require_once sprintf('%s.php', str_replace('\\', DIRECTORY_SEPARATOR, $class));
});
